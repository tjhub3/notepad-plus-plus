...
#define IDD_PREFERENCE_SUB_SEARCHING 6900 //(IDD_PREFERENCE_BOX + 900)
	...
	#define IDC_MULTITHREADED_STATIC (IDD_PREFERENCE_SUB_SEARCHING + 7)
	#define IDC_CHECK_MULTITHREADED (IDD_PREFERENCE_SUB_SEARCHING + 8)
	#define IDC_THREADCOUNT_STATIC (IDD_PREFERENCE_SUB_SEARCHING + 9)
	#define IDC_RADIO_THREADCOUNT_AUTO (IDD_PREFERENCE_SUB_SEARCHING + 10)
	#define IDC_RADIO_THREADCOUNT_CUSTOM (IDD_PREFERENCE_SUB_SEARCHING + 11)
	#define IDC_EDIT_THREADCOUNT (IDD_PREFERENCE_SUB_SEARCHING + 12)
